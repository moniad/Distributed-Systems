...
@javax.annotation.Generated(
    ...
    comments = "Source: ConnectionHealth.proto")
public final class HealthGrpc {
  ...
  public static final io.grpc.MethodDescriptor<gen.ConnectionHealthProto.PingRequest,
      gen.ConnectionHealthProto.PingReply> METHOD_PING =
      io.grpc.MethodDescriptor.<gen.ConnectionHealthProto.PingRequest, gen.ConnectionHealthProto.PingReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "Health", "ping"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              gen.ConnectionHealthProto.PingRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              gen.ConnectionHealthProto.PingReply.getDefaultInstance()))
          .build();
  ...
  public static abstract class HealthImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(gen.ConnectionHealthProto.PingRequest request,
        io.grpc.stub.StreamObserver<gen.ConnectionHealthProto.PingReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                gen.ConnectionHealthProto.PingRequest,
                gen.ConnectionHealthProto.PingReply>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class HealthBlockingStub extends io.grpc.stub.AbstractStub<HealthBlockingStub> {
    ...
    /**
     */
    public gen.ConnectionHealthProto.PingReply ping(gen.ConnectionHealthProto.PingRequest request) {
  ...
  public static final class HealthFutureStub extends io.grpc.stub.AbstractStub<HealthFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<gen.ConnectionHealthProto.PingReply> ping(
        gen.ConnectionHealthProto.PingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((gen.ConnectionHealthProto.PingRequest) request,
              (io.grpc.stub.StreamObserver<gen.ConnectionHealthProto.PingReply>) responseObserver);
          break;
        default:
  ...
  private static final class HealthDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return gen.ConnectionHealthProto.getDescriptor();
    }
  }

...
#
#
from Lab1.homework.ServerSocket import ServerSocket

if __name__ == '__main__':
    server_socket = ServerSocket()

#     todo: add server_tcp??_worker
#     # open_tcp_connection
#     server_tcp_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
#     server_tcp_socket.bind(('localhost', PORT))  # makes IPC faster because skips a couple of network layers
